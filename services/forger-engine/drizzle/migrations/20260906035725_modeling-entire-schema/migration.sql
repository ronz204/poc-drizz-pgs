CREATE TYPE "auth"."tenant_plan" AS ENUM('free', 'pro', 'enterprise');--> statement-breakpoint
...
CREATE TABLE "auth"."tenants" (
	...
	"name" text NOT NULL,
	"plan" "auth"."tenant_plan" NOT NULL,
	"max_services" integer NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "tenants_max_services_positive" CHECK ("max_services" > 0)
);
...
CREATE INDEX "incident_services_service_tenant_idx" ON "core"."incident_services" ("service_id","tenant_id");--> statement-breakpoint
CREATE INDEX "incident_updates_incident_created_idx" ON "core"."incident_updates" ("incident_id","created_at");--> statement-breakpoint
CREATE INDEX "incidents_tenant_status_idx" ON "core"."incidents" ("tenant_id","status");--> statement-breakpoint
CREATE INDEX "incidents_tenant_created_idx" ON "core"."incidents" ("tenant_id","created_at" DESC NULLS LAST);--> statement-breakpoint
ALTER TABLE "core"."incident_services" ADD CONSTRAINT "incident_services_R3qK0haC4Age_fkey" FOREIGN KEY ("tenant_id","incident_id") REFERENCES "core"."incidents"("tenant_id","id");--> statement-breakpoint
ALTER TABLE "core"."incident_services" ADD CONSTRAINT "incident_services_QxcgnUiMtUbO_fkey" FOREIGN KEY ("tenant_id","service_id") REFERENCES "core"."services"("tenant_id","id");--> statement-breakpoint
ALTER TABLE "core"."incident_updates" ADD CONSTRAINT "incident_updates_dPOIZsOdC3qg_fkey" FOREIGN KEY ("tenant_id","incident_id") REFERENCES "core"."incidents"("tenant_id","id");--> statement-breakpoint
ALTER TABLE "core"."incidents" ADD CONSTRAINT "incidents_tenant_id_tenants_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "auth"."tenants"("id");--> statement-breakpoint
ALTER TABLE "core"."services" ADD CONSTRAINT "services_tenant_id_tenants_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "auth"."tenants"("id");--> statement-breakpoint
ALTER TABLE "core"."subscribers" ADD CONSTRAINT "subscribers_tenant_id_tenants_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "auth"."tenants"("id");--> statement-breakpoint
